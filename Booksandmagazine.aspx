<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Booksandmagazine.aspx.cs" Inherits="Booksandmagazine" %>
     ...
     <table style="margin:0 auto" >
         <tr>
                <td  style="text-align: center">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="X-Large" Text="Books and Magazines"></asp:Label>
                </td>
          ...
          <tr>
                <td class="auto-style1" colspan="2" >
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:bdsrConnectionString3 %>" SelectCommand="SELECT * FROM [bnmproducts]"></asp:SqlDataSource>
</td>
              </tr>
         </table>
</asp:Content>
