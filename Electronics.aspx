     ...
     <table style="margin:0 auto" >
         <tr>
                <td  style="text-align: center">
                    <asp:Label ID="Label1" runat="server" Font-Bold="True" Font-Size="X-Large" Text="Electronics"></asp:Label>
                </td>
        ...
        <tr>
                <td class="auto-style1" colspan="2" valign="top">
                    <asp:DataList ID="DataList1" runat="server" DataSourceID="SqlDataSource1"
                        RepeatColumns="4" RepeatDirection="Horizontal" CellPadding="30" OnItemCommand="DataList1_ItemCommand1" OnSelectedIndexChanged="DataList1_SelectedIndexChanged"  >
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:bdsrConnectionString %>" SelectCommand="SELECT * FROM [eproducts]"></asp:SqlDataSource>
